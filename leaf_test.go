...
func TestTerminalLeaf(t *testing.T) {
	...
	goassert.New(t, (*Leaf)(nil)).Equal(terminal1.GetRight())
	goassert.New(t, "terminal leaf does not have threshold").ExpectError(terminal1.GetThreshold())
	goassert.New(t, float32(1.0)).EqualWithoutError(terminal1.GetValue())
...
func TestLeaf(t *testing.T) {
	...
	goassert.New(t, float32(1.0)).EqualWithoutError(leaf1.GetLeft().GetValue())
	goassert.New(t, float32(2.0)).EqualWithoutError(leaf1.GetRight().GetValue())
	goassert.New(t, FeatureID(1), float32(-0.5)).EqualWithoutError(leaf1.GetThreshold())
	goassert.New(t, "non-terminal leaf does not have value").ExpectError(leaf1.GetValue())
